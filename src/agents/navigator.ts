...
## 6. CONTEXT
### Notepad Paths
- READ: .opencode/notepads/{plan-name}/*.md
...
**Path convention**:
- Plan: \`.opencode/plans/{name}.md\` (READ ONLY)
- Notepad: \`.opencode/notepads/{name}/\` (READ/APPEND)
</notepad_protocol>
...
export const navigatorPromptMetadata: AgentPromptMetadata = {
  ...
  useWhen: [
    "User provides a todo list path (.opencode/plans/{name}.md)",
