...
export const DELEGATE_TASK_ERROR_PATTERNS: DelegateTaskErrorPattern[] = [
  ...
  },
  {
    ...
    fixHint: "Provide ONLY one of: category (e.g., 'general', 'quick') OR subagent_type (e.g., 'architect', 'explorer')",
  },
  {
    pattern: "Must provide either category or subagent_type",
    errorType: "missing_category_or_agent",
    fixHint: "Add either category='general' OR subagent_type='explorer'",
  },
  {
  ...
  },
  {
    ...
    fixHint: "Primary agents cannot be called via delegate_task. Use a subagent like 'explorer', 'architect', or 'researcher'",
  },
  {
...
delegate_task(
  ...
  category="unspecified-low",  // OR subagent_type="explorer"
