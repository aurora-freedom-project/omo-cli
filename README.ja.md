...
私たちのメインエージェント、Sisyphus（Claude Opus 4.5 Thinking）を紹介します。以下は、シジフォスが岩を転がすために使用するツールです。

*以下の内容はすべてカスタマイズ可能です。必要なものだけを使ってください。デフォルトではすべての機能が有効になっています。何もしなくても大丈夫です。*

- シジフォスのチームメイト (Curated Agents)
  - Oracle: アーキテクチャ、コードレビュー、デバッグ (Claude Opus 4.5 Thinking)
  - Prometheus: 戦略的プランニング、タスク分解 (Claude Opus 4.5 Thinking)
  - Librarian: 公式ドキュメント、オープンソース実装、コードベース探索 (Minimax M2.1)
  - Explore: 超高速コードベース探索 (Minimax M2.1)
  - Multimodal-Looker: 画像・PDF分析 (Gemini 3 Pro)
  - Metis: プランコンサルタント、隠れた要件発見 (Claude Sonnet 4.5 Thinking)
...
- **スキルライブラリ**: antigravity-awesome-skills から 600以上のスキルをインポート可能
...
Oh My OpenCode は [antigravity-awesome-skills](https://github.com/PierrunoYT/antigravity-awesome-skills) ライブラリから **600以上の厳選されたスキル** にアクセスできます。
...
# Tier 1 をインストール (85個の安全 + 優秀品質スキル)
bunx oh-my-opencode adapt-skills --tier 1

# Tier 1 + 2 をインストール (479個のスキル、推奨)
...
**利用可能なカテゴリ:**
- アーキテクチャ、DevOps、フロントエンド、バックエンド
- AI/ML、テスト、セキュリティ、ドキュメント
- パフォーマンス、クラウド、モバイル、ワークフロー
